...
namespace engine {
	...
	StaticObject* StaticObject::create(int x, int y, int w, int h, Level* my_level, bool solid) {
		return new StaticObject(x, y, w, h, my_level, solid);
	}
	...
	StaticObject::StaticObject(int x, int y, int w, int h, Level* my_level, bool solid) 
		: GameObject(x, y, w, h, my_level, solid)
	{
