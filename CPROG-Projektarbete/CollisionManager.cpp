...
namespace engine {
	...
	void CollisionManager::handle_next_collision(GameObject& obj, std::vector<GameObject*>& objects)
	{
	...
	bool CollisionManager::within_level(GameObject& o, int width, int height)
	{
	...
	/// </summary>
	/// <returns>True if collision, else false.</returns>
	bool CollisionManager::collides_x(GameObject& a, GameObject& b, int vel_x)
	{
	...
	/// </summary>
	/// <returns>True if collision, else false.</returns>
	bool CollisionManager::collides_y(GameObject& a, GameObject& b, int vel_y)
	{
	...
	/// <returns>True if collision, else false.</returns>
	bool CollisionManager::next_tick_collides(GameObject& a, GameObject& b)
	{
